...
export class QuotesComponent implements OnInit {
  ...
  title = 'welcome to Kim quotes';
  quotes:Quote[] = [
    new Quote (1,'Ian', 'Human spirit','The human spirit must prevail over technology to allow humans be in charge.','Albert Einstein', new Date(2019,7,12),0,0),
